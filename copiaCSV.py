...
texto_usuario = navegador.find_element(By.XPATH,'//*[@id="login_name"]')
texto_usuario.send_keys('lchaves.stefanini')
texto_senha = navegador.find_element(By.XPATH,'//*[@id="login_password"]')
texto_senha.send_keys('L8c45@123')
entrar = navegador.find_element(By.XPATH,'//*[@id="boxlogin"]/form/p[3]/input')
entrar.click()
